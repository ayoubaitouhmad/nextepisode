...
public class MovieController {
     ...
     * @throws com.nextepisode.tmdb_service.exception.TmdbApiException if movie not found or no providers available for specified region
     */
    ...
    public MovieList discoverMovies(
            ...
            @RequestParam(required = false, defaultValue = TmdbConstants.DEFAULT_REGION) String region,
